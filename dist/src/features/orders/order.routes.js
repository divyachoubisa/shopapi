...
import { placeOrder, getMyOrders, getOrderById, cancelOrder, getAllOrders, updateOrderStatus, } from "./order.controller";
...
router.patch("/admin/orders/:id/status", requireAdmin, validate(UpdateOrderStatusSchema), updateOrderStatus);
